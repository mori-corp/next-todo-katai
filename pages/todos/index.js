...
export default function Todos() {
  ...
  return (
    <>
      <Header />
      <div className="p-6">
        <h1 className="text-xl mb-4">Todos page</h1>
            ...
            {todos.map((todo) => (
              ...
              >
                ...
                <div className="flex items-center">
                  {/* ステータスのセレクタ */}
                  <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[80px] h-[30px] p-1 mr-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
